...
class CreateStaffBottomSheet extends StatefulWidget {
  ...
  CreateStaffBottomSheet({super.key, required this.notify});
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildInputField(
                  "Staff Name", "Enter Staff Name", _controller.nameController),
              _buildInputField(
                  "Email", "Enter Staff Email", _controller.emailController),
              _buildInputField(
                  "Phone", "Enter Staff Phone", _controller.phoneController),
              _buildInputField(
                  "Password", "Enter Password", _controller.passwordController,
                  obscureText: true),
              SizedBox(height: 20.h),
